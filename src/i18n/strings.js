...
export const ui = {
  en: {
    nav: { featured: 'Little Step', work: 'Case studies', about: 'About', contact: 'Contact' },
    heroCta: {
      littleSteps: 'View Little Step',
      work: 'View case studies',
      resume: 'Download résumé',
      resumePending: 'Résumé · Coming soon',
    },
    home: {
      quickFacts: 'Career highlights',
      buildingNow: 'Building now',
      productFlow: 'Little Step learning flow',
      flowInput: 'Capture a wrong question',
      flowDiagnose: 'Diagnose the cause',
      flowLearn: 'Explain and verify',
      flowResume: 'Write back and resume',
      caseComingSoon: 'View full case study',
      demoPending: 'Demo · Coming soon',
      caseContext: 'Business context',
      caseComplexity: 'Scale & complexity',
      caseAction: 'My action',
      caseResult: 'Result',
  ...
  zh: {
    nav: { featured: '小步学习伙伴', work: '工程案例', about: '关于我', contact: '联系我' },
    heroCta: {
      littleSteps: '查看小步学习伙伴',
      work: '查看工程案例',
      resume: '下载简历',
      resumePending: '简历 · 整理中',
    },
    home: {
      quickFacts: '职业概览',
      buildingNow: '正在开发',
      productFlow: '小步学习伙伴核心流程',
      flowInput: '录入真实错题',
      flowDiagnose: '诊断并确认错因',
      flowLearn: '讲解与理解检查',
      flowResume: '写回并持续复习',
      caseComingSoon: '查看完整案例',
      demoPending: '演示 · 待补充',
      caseContext: '业务背景',
      caseComplexity: '规模与复杂度',
      caseAction: '我的职责和行动',
      caseResult: '最终结果',
      copyEmail: '复制邮箱',
