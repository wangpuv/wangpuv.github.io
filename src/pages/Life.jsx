                ...
                >
                  ...
                  {card.photo && (
                    <figure className="life-photo">
                      <img src={card.photo} alt={c.photoAlt} loading="lazy" decoding="async" />
                    </figure>
                  )}

                  {card.qr && (
                    <figure className="life-qr">
                      <img src={card.qr} alt={c.qrAlt} width="160" height="160" loading="lazy" decoding="async" />
            ...
            {books.map((b, i) => (
              <li className="book" key={i}>
                <div className="book__cover">
                  <img src={b.cover} alt={b.title} width="285" height="411" loading="lazy" decoding="async" />
                </div>
