export const profile = {
  ...
  zh: {
    ...
    about: [
      ...
      '现在我聚焦 AI Agent 工程：已经主导构建了一个完整的学习 Agent，它能调用工具、拥有跨会话的可信记忆；模型不能直接改写数据，每一次写入都要经宿主系统校验，因此行为可验证、可恢复。',
    ...
    experience: [
      {
        ...
        role: '独立开发者',
        org: '自主项目 · 家庭优先的一年',
        note: '陪伴孩子度过升入初中后的适应期；期间独立设计并开发「小步打卡」，2026 年上架 App Store，并主导构建 Little Step Learning Agent，覆盖 1392 项单元与集成测试。',
