...
export const lifeCards = [
  ...
  },
  {
    ...
    en: {
      label: 'WeChat',
      title: '阿诚的代码',
      body: 'My WeChat public account. The Claude Code course is serialised there, and every lesson is mirrored on this site.',
      qrAlt: 'WeChat QR code for 阿诚的代码',
      linkText: 'Read the courses',
      qrCaption: 'Scan to follow',
    },
    zh: {
      label: '公众号',
      title: '阿诚的代码',
      body: '我的微信公众号。《Claude Code 中文教程》在这里连载，每一课也会同步到站点上。扫码即可关注。',
      linkText: '读教程',
