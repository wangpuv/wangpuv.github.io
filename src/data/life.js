...
export const lifeCards = [
  ...
  },
  {
    ...
    en: {
      label: 'WeChat',
      title: '阿诚的代码',
      body: 'My WeChat public account. I am currently serialising a Claude Code course there; every lesson is mirrored on this site.',
      qrAlt: 'WeChat QR code for 阿诚的代码',
      linkText: 'Read the course',
      qrCaption: 'Scan to follow',
    },
    zh: {
      label: '公众号',
      title: '阿诚的代码',
      body: '我的微信公众号。目前在连载《Claude Code 中文教程》，每一课也会同步到这个站点。扫码即可关注。',
      linkText: '读教程',
