$(document).ready(function(){
    ...
    //**评论的代码***
    window.disqus_shortname = 'wangpuvblog'; // required: replace example with your forum shortname
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('wangpuv.github.com')>-1 ){
